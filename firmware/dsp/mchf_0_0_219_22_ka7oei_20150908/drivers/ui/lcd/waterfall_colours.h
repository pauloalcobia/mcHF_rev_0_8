...
//
// Derived with the help of:  http://www.perbang.dk/rgbgradient/
//
// NOTES:
//
//  - The waterfall palettes range from [0] = weakest signal to [63] for the strongest signal
//
//	- The last entry [64] (the 65th) is always reserved for the vertical line color.  You may include it in the table, but it will always be overwritten.
//
//  - The LCD ultimately uses a 16 bit (5,6,5) RGB pallete where there are 5 Blue, 6 Green and 5 Red bits of color resolution, produced by the macro "RGB", below
//
//
#define RGB(red,green,blue)(uint16_t)(((red>>3)<<11)|((green>>2)<<5)|(blue>> 3))
//
//
// Waterfall Gray Colors
//
...
const ushort old_waterfall_cold_hot[]	=	{
	RGB(0x22,0x3a,0xf7),
	RGB(0x25,0x39,0x43),
	RGB(0x29,0x38,0xef),
	RGB(0x2c,0x37,0xeb),
...
const ushort old_waterfall_rainbow[]	=	{
	RGB(0x64,0x00,0xef),
	RGB(0x53,0x00,0xf0),
	RGB(0xf2,0x00,0xf0),
	RGB(0x31,0x00,0xf0),
